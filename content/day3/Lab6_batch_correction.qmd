...
```{r eval = TRUE, batchcorrect_liger2, filename = "R"}
...
```{r eval = TRUE, batchcorrect_liger3, filename = "R"}
...
```{r eval = TRUE, batchcorrect_liger4, filename = "R"}
...
```{r eval = TRUE, batchcorrect_liger5, filename = "R"}
...
```{r eval = TRUE, batchcorrect_liger6, filename = "R"}
...
```{r eval = TRUE, batchcorrect_liger6b, filename = "R"}
...
```{r eval = TRUE, batchcorrect_liger7}
